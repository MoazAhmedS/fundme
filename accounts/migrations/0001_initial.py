    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Phone number must be a valid Egyptian number starting with 010, 011, 012, or 015', regex='^01[0125][0-9]{8}$')], verbose_name='Phone Number')),
